...
* I plcase the client logic in its own task. this was done
...
*    gets very large, servicing each request might slow the UI theard down.
* 2. persistence of data: if tnat is ever a requirement, the thread servicing
