...
unsigned long Socket::convHtonl(unsigned long xi_hostLong)
{ 
	return htonl(xi_hostLong); 
}

unsigned long Socket::convNtohl(unsigned long xi_networkLong)
{
	return ntohl(xi_networkLong); 
}
